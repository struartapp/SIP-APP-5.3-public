...
<br />
  ...
  <select id="pterm" class="max-w-sm h-12 p-2 t-6 rounded overflow-hidden bg-gradient-to-b  from-white to-yellow-400 w-48 shadow-xl shadow-yellow-600  border-orange-800  style" style={{
    fontSize: '15px',   }}  onChange={handleCalculate}>
  ...
  <div id="results" class="px-6 py-2">
            <div class = "max-w-sm h-8 t-6 text-right p-1 rounded overflow-hidden bg-gradient-to-b  from-white to-orange-200 w-48 shadow-xl shadow-yellow-600  border-orange-800 hover:text-white"id="resultd" > </div>
            <div class = "max-w-sm h-8 t-6 text-right p-1 rounded overflow-hidden bg-gradient-to-b  from-white to-orange-200 w-48 shadow-xl shadow-yellow-600  border-orange-800 hover:text-white"id="resultt"> </div>
            <div class = "max-w-sm h-8 t-6 text-right p-1 rounded overflow-hidden bg-gradient-to-b  from-white to-orange-200 w-48 shadow-xl shadow-yellow-600  border-orange-800 hover:text-white"id="resultl"></div>
            <div class = "max-w-sm h-8 t-6 text-right p-1 rounded overflow-hidden bg-gradient-to-b  from-white to-orange-200 w-48 shadow-xl shadow-yellow-600  border-orange-800 hover:text-white"id="results1"></div>
            <div class = "max-w-sm h-8 t-6 text-right p-1 rounded overflow-hidden bg-gradient-to-b  from-white to-orange-200 w-48 shadow-xl shadow-yellow-600  border-orange-800 hover:text-white"id="resultp"></div></div>
