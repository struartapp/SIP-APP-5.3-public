...
<div class="rounded overflow-hidden text-center  bg-clip-border bg-gradient-to-b p-3 from-yellow-200 to-white w-96 h-42 rounded-sd shadow-xl shadow-yellow-600 border-2 border-x-2 border-orange-800" style={{
    ...
    fontSize: '17px',   }} >
            <Link href=""><strong>STRUCTURALLY INSULATED PANELS (SIPS)<br />
              FLOOR PANEL SELECTION</strong></Link> </div></div>
         </li>
...
<br />
  ...
  <button className=" font-semibold text-center bg-clip-border bg-gradient-to-b from-red-400 to-white w-36 h-7 rounded-sd shadow-xl shadow-blue-950/50 border-2 border-blue-500 hover:bg-sky-700 hover:text-white" onClick={handleClear}>Clear</button>
  </div>
  <div class="flex px-6 py-1">
    <div className = "text-red-500 font-semibold border-blue-500" >
      <p><i>It is strongly recommended for floors to have solid timber splines (i.e. reinforced)
